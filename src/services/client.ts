...
/**
 * Single instance consumed by every page/hook. News/Events/Articles/auth are real, served by
 * the `liac-backend` repo (Supabase Edge Functions) at `VITE_API_BASE_URL`; Projects/Team/
 * Partners/contact form stay on local fixtures for now — see `HybridApiClient`.
 *
